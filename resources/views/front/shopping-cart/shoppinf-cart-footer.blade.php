<div class="cart-footer">
    <div class="d-flex flex-column  align-items-end mt-4 pt-4">
        <div class="w-25 d-flex justify-content-between align-items-center">
            <span>數量:</span><span class="count_price" id="qty">{{\Cart::getTotalQuantity()}}</span>
        </div>
        <div class="w-25 d-flex justify-content-between align-items-center">
            <span>小計:</span><span class="subtotal_price" id="subtotal">${{number_format(\Cart::getSubTotal())}}</span>
        </div>
        <div class="w-25 d-flex justify-content-between align-items-center">
            <span>運費:</span><span class="freight_fee" id="charge">$60</span>
        </div>
        <div class="w-25 d-flex justify-content-between align-items-center">
            <span>總計:</span><span class="total_price" id="total">${{number_format(\Cart::getTotal()+60)}}</span>
        </div>
    </div>
